...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            matchDayTextView.setText(Utilities.getMatchDay(context, cursor.getInt(COL_MATCHDAY),
...
//            if (league.equals(context.getResources().getString(R.string.league_not_known_msg))) {
//                league = "";
//            }
            leagueTextView.setText(league);
            Button share_button = (Button) v.findViewById(R.id.share_button);
            share_button.setContentDescription(context.getResources().getString(R.string.contDesc_share_button));
